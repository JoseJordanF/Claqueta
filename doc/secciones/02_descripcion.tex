...
Como aficionado al cine, quiero encontrar películas a través de recomendaciones personalizadas basadas en mis gustos para descubrir nuevos contenidos que se ajusten a mí. También como aficionado al cine, quiero saber si el contenido merece la pena ser consumido.

\subsection{Cinéfilo}

Como cinéfilo, quiero conseguir una visión profesional sobre las películas y series que consumo, a través de reseñas detalladas y fiables. Como cinéfilo, necesito participar en debates y discusiones sobre películas con otros cinéfilos para compartir perspectivas diferentes. Como apasionado del cine, quiero conseguir más contenido que ver, relacionado con mis gustos. Resalto como las series son abandonadas en varias aplicaciones de reseñas.

\subsection{Crítico}

Como crítico de cine, quiero conseguir que lo que escribo llegue a mucha gente que pueda apreciar mi pasión por el cine y use mis críticas para discernir entre buenas películas y no tan buenas desarrollando su pensamiento crítico. Siempre desde el respeto y generando discusiones de interés, viendo la aceptación de estas en mi público. Consiguiendo evaluar mi el impacto de mi trabajo y ver si es reconocido. Querría conseguir ser cercano a mis lectores pudiendo ver su opinión respecto a mi publicación.
...
\begin{itemize}
    \item \textbf{OBJ1} Construir una aplicación que pueda proporcionar un espacio en el que los usuarios encuentren películas apegadas a sus preferencias
   
    \item \textbf{OBJ2} Construir una aplicación que proporcione un espacio para la lectura y punto de encuentro para el intercambio de opiniones sobre películas que consumen los usuarios.
    \begin{itemize}
        \item \textbf{SOBJ2.1} Asegurar la fiabilidad de las reseñas escritas por los usuarios en un %.
    \end{itemize}

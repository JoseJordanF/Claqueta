...
Es por esto que la herramienta elegida sera GitHub debido a la familiaridad que se tiene con esta herramienta y 
...
%PUESTO SI O SI EN CI
También es necesario destacar que en este caso se tiene una debido a que GitHub es especialmente fuerte en términos de comunidad y visibilidad de proyectos, lo que podría ser esencial para compartir y destacar el trabajo de manera más amplia, siendo esta visibilidad sustancial para la resolución de problemas a través de la colaboración con la comunidad. Formando parte de la esencia del enfoque ágil que describimos en la introducción. Y también debido a que se nos ofrece GitHub Actions \cite{BestCI}, una potente herramienta \cite{CI_supp} con la capacidad de automatización directamente integrada en la plataforma y que servirá generalmente para crear la mayoría de flujos de trabajo que necesitemos durante la implementación del proyecto. GitHub será el repositorio para nuestro proyecto 
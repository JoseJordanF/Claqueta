...
la implementación, en los primeros hitos se dedicarán a definir la infraestructura y organización del 
proyecto. Además, habrá que discutir qué herramientas van a usarse para desarrollar o llevar a cabo estos 
hitos y el porqué de su elección. 

Primeramente, se decidirá en este caso que herramienta se usara para albergar el proyecto y poder definir los hitos, 
además de permitir un seguimiento del desarrollo mucho más controlado. Siguiendo así con el enfoque ágil visto en el 
primer capítulo. Tras ello se irán desarrollando cada PMV siguiendo las mejores prácticas posibles y obteniendo un 
producto de calidad, principios afines de nuevo al enfoque ágil.


\section{Herramientas previas}

Por lo tanto, ya que el desarrollo se va a basar en los productos mínimamente viables. Lo primero que 
debemos hacer es definir un repositorio en el que definir estos hitos. Por ello es la primera herramienta
que vamos a elegir. Teniendo en cuenta el uso de git como sistema de control de versiones debido a su 
naturaleza distribuida frente a sistemas como subversion con un modelo centralizado, o su popularidad frente 
a sistemas como mercurial. Porque aunque ambos sistemas poseen características similares, git posee una base 
masiva y activa de usuarios, obteniendo un mejor soporte y una comunidad más robusta, a diferencia de 
mercurial. 

Teniendo esto presente, tenemos varias opciones para escoger un repositorio basado en git que albergue 
nuestro proyecto, de manera gratuita y online. Como por ejemplo GitHub\cite{GH_web}, GitLab\cite{GL_web} y 
Bitbucket\cite{BK_web}, plataformas de desarrollo colaborativo que comparten muchas características, pero 
presentan algunas diferencias. 

En términos económicos, GitHub ofrece planes gratuitos con funciones básicas para repositorios públicos y 
privados, pero también cuenta con planes de pago que incluyen características adicionales y soporte para 
proyectos más grandes o equipos que requieren funciones avanzadas. GitLab también proporciona un nivel 
gratuito con un conjunto de características básicas. Sin embargo, al igual que GitHub, tiene planes de pago 
que ofrecen funciones más avanzadas y capacidad de escalar para adaptarse a las necesidades de equipos y 
organizaciones más grandes. Bitbucket, de Atlassian, ofrece una versión gratuita con características 
esenciales y un límite en el número de colaboradores. Al igual que GitHub y GitLab, hay opciones de pago que 
amplían las capacidades y eliminan restricciones. Aun así, sería conveniente el uso de herramienta como Jira 
o Confluence si usas Bitbucket para un buen seguimiento del proyecto como buena práctica afín con 
el enfoque ágil visto en la introducción, teniendo en cuenta que estas herramientas son de pago, aunque 
disponen de una versión gratuita pero con capacidades básicas para los proyectos más simples. 

En general, las opciones gratuitas de estas plataformas son adecuadas para muchos proyectos pequeños y
medianos, al menos las de GitHub y GitLab. Por ello, la elección entre una de estas plataformas depende de 
otros factores, ya que son herramientas muy parecidas. Comparativamente, en relación con GitLab, GitHub ha 
establecido una posición fuerte en el ámbito de desarrollo colaborativo y es ampliamente adoptado en la comunidad de 
código abierto.

Por lo tanto, debido a que GitHub es especialmente fuerte en términos de comunidad y visibilidad de 
proyectos, lo que podría ser esencial para compartir y destacar el trabajo de manera más amplia, siendo esta 
visibilidad sustancial para la resolución de problemas a través de la colaboración con la comunidad. Formando parte 
de la esencia del enfoque ágil que describimos en la introducción. Y también debido a que se nos ofrece GitHub 
Actions \cite{BestCI}, una potente herramienta \cite{CI_supp} con la capacidad de automatización directamente 
integrada en la plataforma y que servirá generalmente para crear la mayoría de flujos de trabajo que necesitemos 
durante la implementación del proyecto. GitHub será el repositorio para nuestro proyecto 
\footnote{\url{https://github.com/JoseJordanF/Claqueta}}.

Una vez escogido el repositorio nos podemos disponer a dividir la implementación del software en hitos. 
Estos han sido definidos en GitHub y cada uno de ellos contiene un grupo de \textit{issues} que se 
corresponden con las distintas mejoras que se han ido incorporando al proyecto a lo largo de su desarrollo.

El uso de herramientas permiten llevar a cabo el proyecto, asegurando su calidad y buenas prácticas 
durante el uso de estas, velando por el enfoque ágil descrito en el primer capítulo.
...
Por otra parte, la creación del flujo es prácticamente instantánea debido a la guía por parte de GitHub. 

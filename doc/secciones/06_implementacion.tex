...
de España\cite{TablaAmortizacion} tiene una vida útil de 5 años y un coeficiente lineal máximo del 40\%. Podemos 
...
\begin{equation}
    1500-600 = 900
\end{equation}
Y sobre este valor aplicamos el coeficiente lineal máximo:
\begin{equation}
    900\cdot0.4 = 360
\end{equation}
...
\subsection{Total costes}

Por lo que sí unimos los costes de amortización y el salario del estudiante quedaría un coste de 4860€.
...
Estas interacciones forman parte de la aplicación cliente, aplicación que no forma parte de la lógica de negocio, ya que 
esta sirve como interfaz gráfica para el usuario, muestra los datos y le permite interactuar con ellos. Pero todas las 
operaciones sobre estos, sea sé la lógica de negocio, se llevan a cabo en la aplicación que se está desarrollando en este 
momento. Por lo tanto, la aplicación cliente cuando empiece a desarrollarse %link primer hito sobre la aplicacion cliente

Por lo que compete a la lógica de negocio con respecto al sistema de reputación, de momento se podrán crear un par de 
operaciones que aumenten o disminuyan la reputación de cierto usuario. La cantidad sumada o reducida dependerá de las 
interacciones una vez exista la aplicación cliente y se establezca un sistema de puntuación.
=======
>>>>>>> 2d990170b47376e6dc5ed2f14923494435660083

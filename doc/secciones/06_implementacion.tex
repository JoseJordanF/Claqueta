...
capa de persistencia que guarda y recupera datos de archivos Json llamada 
\begin{otherlanguage}{english}``\textit{\textbf{DatabasePersistenceLayer}}''\end{otherlanguage}
